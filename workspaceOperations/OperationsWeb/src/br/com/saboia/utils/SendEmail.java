...
import br.com.saboia.facade.impl.LogEmailSendFacadeImpl;

@Stateless
public class SendEmail {
	
	private final String EMAIL_REMETENTE = "no-reply@oracle.com"; //"teste.saboia@gmail.com";
	...
	private final String EMAIL_LOG = "log.saboia@gmail.com";
...
//		email.setSmtpPort(587);
	...
	public String montaHtmlEmailRemenberPass(String msg){
		...
		html.append("<img border='0' width='80' height='18' style='float: right;' src='"+request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+request.getContextPath()+"/faces/javax.faces.resource/saboia.png?ln=images'>");
		html.append("<u></u><u></u>");
		html.append("</p>");
		html.append("</td>");
		html.append("</tr>");							
	...
	public static void main(String[] args) {
		...
		list.add("fernando@saboia.com.br");
		
		try {
			sendEmail.sendHtmlEmail("TESTE DE EMAIL ENVIADO VIA CODIGO JAVA "+ new Date(),"fernando@saboia.com.br", list, "Material Not Classified", quote , "QUOTE");
		} catch (Exception e) {
...
//                              InternetAddress.parse("fernando@saboia.com.br"));
